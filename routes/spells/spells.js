...
module.exports = {
    setup: (app, db) => {
        ...
        app.get(endpoint, (req, res) => {
            ...
            db.serialize(() => {
                db.each(sqlHelper.addSqlParam(`SELECT dnd_spell.id AS guid, dnd_spell.rulebook_id AS rulebook, dnd_spell.school_id AS school, dnd_spell.sub_school_id AS subschool, * 
                                    FROM dnd_spell
